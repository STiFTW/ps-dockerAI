...
# DMR passes the DMR_URL var to all services with dependencies
MODEL_HOST = os.getenv("DMR_URL", "http://model-runner.docker.internal/engines/v1")
            ...
            try:
                ...
                if not has_system:
                    openai_messages.append({
                        "role": "system",
                        "content": "You are a helpful assistant. Keep your responses simple. Limit responses to no a maximum of two sentences. Never ask if you can help with anything else."
                    })
